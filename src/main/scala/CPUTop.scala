...
class CPUTop extends Module {
  ...
  alu.io.op2 := Mux(
    controlUnit.io.immediate,
    Cat(Fill(16, "b0".U), programMemory.io.instructionRead(19, 4)),
    registerFile.io.data2
  )
  ...
  registerFile.io.writeData := Mux(
    controlUnit.io.loadFromMem,
